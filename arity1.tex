  ...
  \begin{center}
    \begin{tabular}{ccc}
      \begin{tikzpicture}[thick,scale=0.8, every node/.style={scale=0.8}]
        ...
        \draw [dotted] [red] (0.5, 0.866) -- (1.0, 0.0);
        \draw [dotted] [red] (1.5, 0.866) -- (2.0, 0.0);
        \draw [dotted] [red] (2.5, 0.866) -- (3.0, 0.0);
      ...
      \begin{tikzpicture}[thick,scale=0.8, every node/.style={scale=0.8}]
        ...
        \draw (-0.5, 0.866) -- (-1.5, 0.866);
        \draw [dotted] [red] (0.5, 0.866) -- (1.0, 0.0);
        \draw [dotted] [red] (-0.5, 0.866) -- (0.0, 0.0);
        \draw [dotted] [red] (-1.5, 0.866) -- (-2.0, 0.0);
      ...
      \begin{tikzpicture}[thick,scale=0.8, every node/.style={scale=0.8}]
        ...
        \draw [dotted] [red] (0.5, 0.866) -- (1.0, 0.0);
        \draw [dotted] [red] (-0.5, 0.866) -- (0.0, 0.0);
        \draw [dotted] [red] (-1.5, 0.866) -- (-1.0, 0.0);
...
\begin{figure}
  \begin{center}
    ...
    \end{tabular}
    \caption{Being nondeterministic when reaching a corner of $\hexagon_p^n$}
    \label{fig:hexcorner}
  \end{center}
\end{figure}
  ...
  \begin{center}
    \begin{tabular}{cc}
      \begin{tikzpicture}[thick,scale=0.8, every node/.style={scale=0.8}]
        ...
        \draw [dotted] [red] (1.5, 0.866) -- (1.0, 0.0);
        \draw [dotted] [red] (1.0, 1.732) -- (0.5, 0.866);
        \draw [dotted] [red] (1.0, 1.732) -- (0.5, 0.866);
      \end{tikzpicture}
  ...
  \begin{center}
    \begin{tabular}{ccc}
      ...
      \begin{tikzpicture}[thick,scale=0.8, every node/.style={scale=0.8}]
        ...
        \draw [dotted] [red] (1.5, 0.866) -- (2.0, 0.0);
        \draw [dotted] [red] (2.5, 0.866) -- (3.0, 0.0);
        \draw [dotted] [red] (3.5, 0.866) -- (4.0, 0.0);
        \fill (1.5, -0.5) node [below] {(a)};
      \end{tikzpicture}
