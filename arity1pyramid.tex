...
\begin{itemize}
	...
	\item $\mathrm{row}_{i+1}=(\mathrm{row}_i[2..|\mathrm{row}_i|-1])^r$ for $i\in \{1,\dots, 2k-1\}$, that is each row is the reverse of the previous without the first and last bead.
\end{itemize}
