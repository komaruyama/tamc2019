...
\begin{theorem}[$\delta\in\{ 2,3\}, \alpha = 1$]\label{thm:d23a1}
	A deterministic unary oritatami system at arity $\alpha = 1$ and delay $\delta \in \{2,3\}$ can fold into a terminal conformation of length at most $3n^2+4n+2$.
\end{theorem}
...
\begin{lemma}[$\delta=2, \alpha =1$]\label{lem:d2a1}
	A deterministic unary oritatami system of $\delta=2$ and $\alpha = 1$ can fold into a conformation of length at most $3n^2+4n+2$.
\end{lemma}
\begin{proof}
...
\begin{lemma}[$\delta=3, \alpha =1$]\label{lem:d3a1}
	A deterministic unary oritatami system of $\delta=3$ and $\alpha = 1$ can fold into a terminal conformation of length at most $3n^2+4n+2$.
\end{lemma}
\begin{proof}
