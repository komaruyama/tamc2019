...
In this case, the point where $w[i-1]$ is stabilized is considered to be an \textit{entrance of the tunnel section} and the point where $w[i+1]$ is stabilized is considered as its \textit{exit}. 
