...
\begin{figure}[tb]
  ...
  \centering
	...
	\node[above] at (180:1) {$p_1$};
	\node[above] at (60:2) {$p_2$};
	\node[above,shift=(120:1)]at (60:1) {$p_3$};
	\node[above]at (0:1) {$p_4$};
    ...
    \end{minipage}
    \end{tabular}
    \caption{The bead $w[i]$  the first bead outside $\hexagon^n_0$: (Left) $w[i+1]$ elongated to west, (Right) $w[i+1]$ elongated to east.}
    \label{fig:ttt_d2}
  \end{center}
\end{figure}
