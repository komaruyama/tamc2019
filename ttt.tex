...
\begin{figure}[h]
  \begin{center}
    \begin{tikzpicture}
      ...
      \node at(2.5,1) {Out of tunnels};
      \node at (2.5,4) [rectangle, draw,rounded corners] (enter) {Entrance of a tunnel};
      \node at(2.5,2) [rectangle, draw, rounded corners] (outside) {Far away of tunnels};

      
      
      \draw[thick]
      (9.3,1)--(8,1)--(8,5)--(13,5)--(13,1)--(11.7,1);
      \node at(10.5,1) {Inside of tunnels};
      \node at(10.5,4) [rectangle, draw, rounded corners] (next-tunnel) {Next to a tunnel};
      \node at(10.5,2) [rectangle, draw, rounded corners] (next-outside) {Next to outside};
...
\begin{figure}[h]
  \begin{center}
    \begin{tikzpicture}
      ...
      \draw[dashed] (-60:0.1) -- (-60:1.4);
      
      \begin{scope}[shift=(60:1.5)]
        \draw[transform canvas={shift=(0:0)}](-0.1,-0.1)--(0.1,0.1);
        \draw[transform canvas={shift=(0:0)}](0.1,-0.1)--(-0.1,0.1);
        
        \foreach \theta in {60,120,0}{
          \draw[transform canvas={shift=(\theta:1.5)}](-0.1,-0.1)--(0.1,0.1);
          \draw[transform canvas={shift=(\theta:1.5)}](0.1,-0.1)--(-0.1,0.1);
        }

        \draw[->] (60:1.4)--(60:0.1);
        \draw[->] (180:0.1)--(180:1.4);
        \draw[dashed] (120:0.1)--(120:1.4);
        \draw[dashed] (0:0.1)--(0:1.4);

        \begin{scope}[shift=(0:1.5)]
          \foreach \theta in {60,0}{
            \draw[transform canvas={shift=(\theta:1.5)}](-0.1,-0.1)--(0.1,0.1);
            \draw[transform canvas={shift=(\theta:1.5)}](0.1,-0.1)--(-0.1,0.1);
          }
          \draw[dashed] (120:0.1)--(120:1.4);
      ...
      \begin{scope}[shift=(0:1.5)]
        ...
        \draw(0:3) circle [radius=0.1];
        \draw[shift=(0:1.5),shift=(-60:1.5)] circle [radius=0.1];
        \foreach \theta in {-60}{
          \draw[transform canvas={shift=(\theta:1.5)}](-0.1,-0.1)--(0.1,0.1);
          \draw[transform canvas={shift=(\theta:1.5)}](0.1,-0.1)--(-0.1,0.1);
        }
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      (outside) edge [bend left] node[left] {$-1$} (enter)
                edge [loop left, transform canvas={xshift=-1cm}] node[left] {$\pm 0$} (outside)
