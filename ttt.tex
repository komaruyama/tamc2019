      ...
      \centering
        \begin{tikzpicture}
          ...
          \begin{scope}[shift=(0:2.4)]
            ...
            \node[below] at (180:1.2) {$w_{i-2}$};
            \node[right] at (0:0) {$w_{i-1}$};
            \node[right] at (-120:1.2) {$w_i$};

            \node[left] at (120:1.2) {B};
            \node[left] at (60:1.2) {C};
            \node[left] at (0:1.2) {D};
            ...
            \begin{scope}[shift=(-120:1.2)]
              ...
              \node[right] at (-120:1.2) {e};
              \node[right] at (-60:1.2) {f};
            \end{scope}
      ...
      \centering
        \begin{tikzpicture}
          ...
          \begin{scope}[shift=(-60:1.2),shift=(0:1.2)]
            ...
            \node[left] at (120:1.2) {A};
            \node[left] at (60:1.2) {B};
            \node[left] at (0:1.2) {C};
            ...
            \begin{scope}[shift=(-120:1.2)]
              ...
              \node[right] at (180:1.2) {e};
              \node[right] at (-120:1.2) {f};
              \node[right] at (-60:1.2) {g};
            \end{scope}
...
\begin{figure}
  \begin{center}
        ...
        \draw[->,white] (-70:0.1) -- (-70:3);
          ...
          \node[below] at (180:1.2) {$t_1$};
          \node[right] at (0:0) {$t_2$};
          \node[left] at (-120:1.2) {$t_3$};

          \node[right] at (120:1.2) {A};
          \node[right] at (60:1.2) {B};
          \node[right] at (0:1.2) {C};
